...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const rowsRes = await sb.from("chat_orders")
      .select("id,display_name,raw_message,published_at,parse_status,parsed_product_id,parsed_product_name,parsed_variant,parsed_qty,parsed_matched_by,parsed_options,parsed_candidates,parsed_reason,parsed_items")
