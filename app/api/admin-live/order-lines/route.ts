      ...
      try {
        ...
        for (const code of Object.keys(byCode)) {
          ...
          const peers = others.filter((o) => isCombinedShipmentPeer(
            { code, addr: m.addr, kakao: m.kakao, phones: m.phones, broadcast: m.broadcast, day: m.day, paymentMethod: m.paymentMethod },
            { code: clean(o.order_lookup_code), addr: shippingAddressKey(o.address, o.detail_address), kakao: clean(o.kakao_id), phone: clean(o.customer_phone), broadcast: clean(o.broadcast_id), day: clean(o.created_at).slice(0, 10), paymentMethod: clean(o.payment_method) },
          ));
          if (peers.length > 0) {
