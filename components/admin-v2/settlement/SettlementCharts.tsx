...
export default function SettlementCharts({
  ...
  return (
    <div className="grid items-start gap-4 xl:grid-cols-[1.55fr_0.45fr]">
      <div className="overflow-hidden rounded-[28px] border border-slate-200 bg-white p-4 shadow-[0_14px_34px_rgba(15,23,42,0.045)]">
        ...
        {trendRows.length === 0 ? (
          <div className="mt-4 flex h-[210px] items-center justify-center rounded-[24px] bg-slate-50 text-sm font-black text-slate-400">
            표시할 기간별 정산 데이터가 없습니다.
          </div>
        ) : (
          <div className="mt-4 rounded-[24px] bg-slate-50 p-3">
            <div className="overflow-x-auto">
              <div className="flex min-h-[185px] min-w-[520px] items-end gap-4 rounded-[22px] bg-white/60 px-3 pb-3 pt-5">
                {trendRows.map((item) => {
