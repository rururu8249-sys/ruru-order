        ...
        <table className="mx-auto min-w-[760px] max-w-[860px] w-full border-separate border-spacing-0">
          ...
          <thead>
            <tr className="bg-slate-50">
              ...
              <th className="px-3 py-3 text-center text-xs font-black text-slate-500">상태</th>
              <th className="px-3 py-3 text-center text-xs font-black text-slate-500">상세</th>
            </tr>
          </thead>
              ...
              visibleRows.map((row, index) => {
                ...
                return (
                  <tr key={rowKey} className="group border-b border-slate-100 transition hover:bg-blue-50/40">
                    ...
                    <td className="border-b border-slate-100 px-3 py-4 text-right text-base font-black tabular-nums text-slate-950">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 border-t border-slate-100 bg-white px-5 py-4">
        ...
        <div className="flex flex-wrap items-center gap-3">
          <select
            ...
            className="h-10 rounded-2xl border border-slate-200 bg-white px-3 text-xs font-black text-slate-600 outline-none transition hover:border-blue-200 focus:border-blue-400 focus:ring-4 focus:ring-blue-50"
          ...
          <div className="flex flex-wrap items-center gap-1">
            <button
              ...
              className="h-9 min-w-9 rounded-xl border border-slate-200 bg-white px-3 text-xs font-black text-slate-500 transition hover:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-40"
            >
              이전
            </button>
