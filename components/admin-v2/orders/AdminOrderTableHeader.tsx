...
export default function AdminOrderTableHeader() {
  return (
    <div className="hidden w-full min-w-[1240px] grid-cols-[120px_140px_170px_minmax(420px,1fr)_120px_120px_130px_80px] bg-neutral-900 px-6 py-3 text-[13px] font-black text-white lg:grid">
