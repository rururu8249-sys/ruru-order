    ...
    <>
      ...
      {open ? (
        <div
          ...
          data-ruru-event-ui-shell="event-panel-winner-management-only-v1"
        >
              ...
              <div className="grid h-full min-h-0 gap-5 xl:grid-cols-[310px_minmax(0,1fr)_430px]">
                <section className="flex min-h-0 flex-col overflow-hidden rounded-[26px] border border-slate-200 bg-white p-4 shadow-sm">
                  ...
                  <div className="mt-4 rounded-3xl border border-slate-200 bg-slate-50 p-3">
                    <div className="mb-2 inline-flex w-full rounded-2xl bg-slate-100 p-1">
                      <button
                        type="button"
                        onClick={() => changeParticipantSource("auto")}
                        className={[
                          "h-9 flex-1 rounded-xl text-xs font-black transition",
                    ...
                    <div className="text-xs font-black text-slate-500">
                      현재 기준: {participantSource === "auto" ? "주문서 자동 명단" : "수동 입력 명단"}
                    </div>
                  </div>

                  <div className="mt-4 flex min-h-0 flex-1 flex-col rounded-3xl border border-slate-200 bg-white p-3">
                    <div className="mb-2 flex items-center justify-between">
                      <div className="text-base font-black text-slate-950">수동 참가자</div>
                    ...
                    <textarea
                      ...
                      className="min-h-[110px] flex-1 resize-none rounded-2xl border border-slate-200 bg-slate-50 p-3 text-sm font-bold text-slate-800 outline-none focus:border-violet-400"
                    />
                    <button
                      type="button"
                  ...
                  <div className="mt-4 shrink-0 rounded-3xl border border-slate-200 bg-white p-3">
                ...
                <main className="flex min-h-0 flex-col gap-4 overflow-hidden">
                  <section className="min-h-0 flex-[1.05] overflow-hidden rounded-[26px] border border-slate-200 bg-white p-4 shadow-sm">
                    <div className="mb-3 flex items-start justify-between gap-4">
                      <div className="min-w-0">
                        <div className="text-xl font-black text-slate-950">주문서 작성자 명단 자동</div>
                        <div className="mt-1 text-xs font-bold text-slate-500">
                          총 {autoParticipantCount.toLocaleString("ko-KR")}명 · 닉네임 기준 중복 제거
                        </div>
                      </div>
                      <div className="shrink-0 rounded-full bg-violet-50 px-3 py-2 text-xs font-black text-violet-700">
                        주문 / 금액
                      </div>
                    </div>

                    <div className="h-[calc(100%-58px)] min-h-0 divide-y divide-slate-100 overflow-y-auto rounded-3xl border-2 border-violet-100 bg-white">
                      {participants.length === 0 ? (
                        ...
                        participants.slice(0, 260).map((item, index) => (
                          <div
                            ...
                            className="grid grid-cols-[40px_minmax(0,1fr)_130px] items-center gap-3 px-4 py-2.5 text-sm"
                          >
                  ...
                  <section className="min-h-0 flex-1 overflow-hidden rounded-[26px] border border-slate-200 bg-white p-4 shadow-sm">
                    ...
                    {eventTab === "roulette" ? (
                      <div className="grid h-[calc(100%-52px)] min-h-[280px] gap-4 lg:grid-cols-[minmax(0,1fr)_250px]">
                        <div className="relative overflow-hidden rounded-3xl border border-violet-100 bg-[radial-gradient(circle_at_50%_42%,#ffffff_0%,#f4efff_45%,#2d1f66_100%)] p-6">
                          ...
                          <div className="flex h-full items-center justify-center">
                            <div className="relative flex h-[220px] w-[220px] items-center justify-center rounded-full bg-white/90 shadow-2xl ring-8 ring-violet-100">
                              <div className="absolute inset-4 rounded-full border-[32px] border-violet-300 border-r-rose-300 border-t-amber-300 border-b-blue-300" />
                        ...
                        <div className="grid h-full gap-3 md:grid-cols-3">
                          {[1, 2, 3].map((step) => (
                            <div key={step} className="relative overflow-hidden rounded-3xl border border-pink-100 bg-gradient-to-b from-pink-50 to-white p-3">
                              ...
                              <div className="mx-auto mt-8 flex h-[230px] max-w-[210px] flex-col overflow-hidden rounded-t-[34px] border-[7px] border-pink-400 bg-white/70 shadow-inner">
                                ...
                                <div className="relative min-h-0 flex-1 overflow-hidden bg-white/45 backdrop-blur-[1px]">
                                  ...
                                  />
                                  <div className="absolute bottom-0 left-0 right-0 flex h-14 items-end justify-center gap-1 px-2">
                                    {["bg-pink-400", "bg-emerald-400", "bg-blue-400", "bg-violet-400", "bg-amber-300", "bg-rose-400"].map((color, index) => (
                                      <span key={index} className={["h-6 w-6 rounded-full shadow-sm", color].join(" ")} />
                                    ))}
                                  </div>
                                  <div className="absolute bottom-8 left-1/2 flex -translate-x-1/2 items-end gap-1">
                                    <span className="h-9 w-7 rounded-t-full bg-orange-300" />
                                    <span className="h-10 w-8 rounded-t-full bg-red-400" />
                                    <span className="h-9 w-7 rounded-t-full bg-green-300" />
                                  </div>
                                  {step === 3 ? (
                                ...
                                <div className="flex h-11 shrink-0 items-center justify-center gap-5 bg-pink-500">
                  ...
                  <section className="flex min-h-0 flex-1 flex-col overflow-hidden rounded-[26px] border border-slate-200 bg-white shadow-sm">
                    ...
                    <div className="min-h-0 flex-1 overflow-y-auto px-4 py-4">
                      {recentWinners.length === 0 ? (
                        <div className="flex h-full min-h-[320px] items-center justify-center rounded-2xl border border-dashed border-slate-200 bg-white px-4 text-center text-sm font-bold text-slate-400">
                          아직 당첨자 기록이 없습니다.
                        </div>
                      ) : (
