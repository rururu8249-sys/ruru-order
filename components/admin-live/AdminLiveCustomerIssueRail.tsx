...
function IssueCard({
  ...
  ledgerInfo?: { stage?: string; kind?: string; amount_final?: number; method?: string; done_at?: string; bank?: string; account_holder?: string; exchange_option?: string; account_number?: string; account_last4?: string; card_total?: number } | null;
...
export default function AdminLiveCustomerIssueRail({ customerOptions = [] }: Props) {
  ...
  const [ledgerByTask, setLedgerByTask] = useState<Record<string, { id: string; stage: string; kind: string; amount_final: number; method: string; done_at: string; bank: string; account_holder: string; exchange_option: string; account_number: string; account_last4: string; card_total: number }>>({});
