...
export const ADMIN_LIVE_MENUS: AdminLiveMenuItem[] = [
  {
    ...
    icon: "📡",
    desc: "라이브 컨트롤타워",
    sidebarNotice: "방송 메뉴는 실시간 주문·입금확인 중심입니다. 주문관리/고객관리/정산통계는 별도 화면으로 확장합니다.",
    readyTitle: "방송 컨트롤타워",
    readyDescription: "라이브 방송, 주문, 입금확인, 고객이슈를 한 화면에서 관리합니다.",
    checkpoints: ["방송 시작/종료", "유튜브 영상·채팅", "실시간 주문", "입금확인 필요 주문"],
  },
  {
    key: "orders",
    label: "주문관리",
  ...
  },
  {
    ...
    readyDescription: "방송별·날짜별 매출, 입금, 미입금, 카드결제 통계를 조회 전용으로 구성합니다.",
    checkpoints: ["방송별 매출", "날짜별 통계", "입금/미입금", "카드결제", "상품 랭킹"],
  },
  {
    key: "settings",
    label: "설정",
