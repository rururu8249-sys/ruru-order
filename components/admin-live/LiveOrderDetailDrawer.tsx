...
export default function LiveOrderDetailDrawer({ order }: Props) {
  const totalAmount = order.productAmount + order.shippingFee;

  return (
    <aside className="sticky top-4 flex max-h-[660px] flex-col rounded-2xl border border-slate-200 bg-white p-3 shadow-sm">
      ...
      <div className="shrink-0 rounded-2xl border border-slate-200 bg-slate-50 p-3 text-xs">
      ...
      <div className="mt-2 min-h-0 flex-1 overflow-y-auto pr-1">
        ...
        <div className="max-h-[122px] overflow-y-auto rounded-xl border border-slate-200">
