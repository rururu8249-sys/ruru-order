          ...
          {activeMenu === "broadcast" ? (
            <>
              ...
              <div className="mb-4 mt-4 grid w-full grid-cols-12 items-stretch gap-3">
                <div className="col-span-12 h-[520px] min-h-0 min-w-0 xl:col-span-8 [&>*]:h-full [&>*]:min-h-0 [&>*>*]:h-full [&>*>*]:min-h-0">
                  <LiveBroadcastPanels videoRatio={videoRatio} youtubeUrl={activeBroadcast?.youtube_live_url || ""} />
                </div>

                <div className="col-span-12 h-[520px] min-h-0 min-w-0 xl:col-span-4 [&>*]:h-full [&>*]:min-h-0">
