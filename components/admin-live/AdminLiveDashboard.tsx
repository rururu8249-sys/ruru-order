        ...
        <main className="min-w-0 flex-1 overflow-x-hidden px-5 py-4">
          ...
          <div className={activeMenu !== "broadcast" ? "pointer-events-none" : ""}>
            ...
            <section className="mt-2 flex items-stretch gap-3">
              <div className="min-w-0 flex-1 sticky top-0 self-start min-h-[1000px]">
                <LiveOrderTable
              ...
              {matchPanelOpen ? (
                <div
                  className="sticky top-0 w-[380px] shrink-0 max-h-[1000px] overflow-y-auto rounded-2xl border border-slate-200 bg-white shadow-xl"
