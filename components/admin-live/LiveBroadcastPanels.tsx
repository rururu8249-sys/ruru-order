...
export default function LiveBroadcastPanels({ videoRatio, youtubeUrl }: Props) {
  ...
  return (
    <section className="mb-4 grid grid-cols-12 items-stretch gap-3">
      <div className="col-span-12 rounded-2xl border border-slate-200 bg-white p-3.5 shadow-sm lg:col-span-3 h-[460px] flex flex-col">
      ...
      <div className="col-span-12 rounded-2xl border border-slate-200 bg-white p-3.5 shadow-sm lg:col-span-5 h-[460px] flex flex-col">
