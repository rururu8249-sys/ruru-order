      ...
      <section className="w-full max-w-[520px] rounded-[28px] border border-slate-200 bg-white p-5 shadow-2xl">
        ...
        <label className="mt-4 block">
          ...
          <textarea
            ...
            className="mt-2 min-h-[110px] w-full resize-none rounded-2xl border border-slate-200 bg-white p-3 text-[15px] font-bold text-slate-800 outline-none focus:border-coral-500 focus:ring-4 focus:ring-coral-50"
          />
        </label>
        ...
        <div className="mt-5 flex justify-end gap-2">
          ...
          <button
            ...
            className="h-11 rounded-xl bg-coral-600 px-5 text-sm font-black text-white active:scale-[0.98] disabled:cursor-not-allowed disabled:bg-coral-200"
          >
            주소 적용
          </button>
        </div>
