        ...
        <div className="max-h-[86dvh] overflow-y-auto px-4 pb-[calc(16px+env(safe-area-inset-bottom))] pt-5">
          ...
          {showCardGuide && (
            <section className="mt-4 rounded-[22px] bg-blue-50 p-4 ring-1 ring-blue-100">
              <div className="flex items-start gap-3">
                <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-[16px] bg-white text-[23px] ring-1 ring-blue-100">
                  💳
                </div>
                <div className="min-w-0">
                  <h3 className="text-[18px] font-black tracking-[-0.06em] text-blue-950">
                    카드결제 안내
                  </h3>
                  <p className="mt-1 break-keep text-[13px] font-bold leading-relaxed tracking-[-0.04em] text-blue-800">
          ...
          {isOrderComplete && (
            <section className="mt-4 rounded-[22px] bg-white p-4 ring-1 ring-slate-200">
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-start justify-between gap-3">
                          ...
                          <p className="shrink-0 text-right text-[14px] font-black text-blue-700">
                            {won(amount)}
                          </p>
                        </div>
                      </div>
              ...
              <div className="mt-3 rounded-[18px] bg-blue-50 p-3 ring-1 ring-blue-100">
                ...
                <div className="mt-2 flex items-center justify-between border-t border-blue-100 pt-3 text-[17px] font-black text-slate-950">
                  <span>{safePointUsedAmount > 0 ? "최종 결제금액" : "결제금액"}</span>
                  <span className="text-blue-700">{won(safeFinalAmount)}</span>
                </div>
              </div>
            </section>
          )}
