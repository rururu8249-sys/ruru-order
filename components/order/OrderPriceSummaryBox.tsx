    ...
    <section className="rounded-[28px] bg-white p-5 shadow-[0_12px_26px_rgba(30,64,175,0.08)] ring-1 ring-blue-100">
      ...
      <div className="mt-4 rounded-[22px] bg-blue-50 p-4 ring-1 ring-blue-100">
        ...
        {customerPointLoading ? (
          <div className="mt-4 rounded-2xl bg-white/80 px-4 py-3 text-[13px] font-black text-blue-700 ring-1 ring-blue-100">
            포인트 확인중...
          </div>
        ) : showPointUse ? (
          <div className="mt-4 rounded-2xl bg-white px-4 py-4 ring-1 ring-blue-100">
            <div className="flex items-center justify-between gap-3 text-[13px] font-black text-blue-800">
              <span>보유 포인트</span>
          ...
          <div className="mt-4 rounded-2xl bg-white px-4 py-3 text-[13px] font-bold leading-relaxed text-slate-600 ring-1 ring-blue-100">
        ...
        {safePointUsedAmount > 0 && (
          <div className="mt-3 flex justify-between text-sm font-black text-emerald-700">
            <span>포인트 사용</span>
