...
- ⏳ P4 상품목록(검색+2열격자+방송중배지+품절+페이지네이션) / P5 옵션펼침(색상·사이즈·수량+필수경고+담기) / P6 담기 confetti 토스트 / P7 주문서(결제 무통장·카드+7%/금액내역/적립예정/제출) / P8 메뉴 세부 / P9 주문조회 배지(입금확인초록/택배출고파랑/입금대기노랑/출고대기)
  ※ P4~P9는 기존 코랄 렌더(~900줄)+장바구니/제출/결제/포인트 로직과 깊게 얽힘 → 결제흐름 안 깨지게 섹션별 정밀 교체(추가형 아님)
