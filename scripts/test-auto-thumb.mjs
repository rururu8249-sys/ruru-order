...
const cases = [
  ...
  // 영양제·인형·마사지 (2026-09-03 "알아서" 지시로 신설)
  ["연어콜라겐&글루타치온60정", "supplement"], ["글루타치온 뷰티라이프 30포", "supplement"],
  ["리얼골드 브로멜라인 파인애플 효소", "supplement"], ["맥스슬림프로 바이오 4개월치 약국판매용", "supplement"],
  ["더존건강 올리브캡슐72캡슐", "supplement"], ["니아르 가르시아 1박스 28정", "supplement"],
  ["골드카무트효소30포", "supplement"], ["떠아님 짱구공룡인형", "toy"], ["피카츄 인형", "toy"],
  ["마사지", "daily"], ["마사지크림", "skincare"], ["비타민C 세럼", "skincare"],
